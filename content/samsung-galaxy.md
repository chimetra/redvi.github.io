...
- GPRS
- GPS навигатор
- В модель (вроде бы, не пользуюсь, не смотрю) включена поддержка NFS, позволяющая обмениваться файлами с android-устройствами неподалёку. Но это нововведение ещё под большим вопросом, по крайней мере, с точки зрения безопасности лучше не использовать.
...
![dr.web](http://farm8.staticflickr.com/7343/9303714685_e01e08355a_o.png)
