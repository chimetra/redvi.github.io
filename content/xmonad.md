...
Неплохо было бы сразу заставить работать мультимедийные клавиши. Здесь нам пригодится уже упомянутая [в заметке про openbox](http://www.unix-lab.org/posts/openbox/) программка xmodmap.
